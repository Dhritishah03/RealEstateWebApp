...
const PropertyDetails = () => {
  ...
  return (
    <div className='flex justify-center max-w-[700px] h-max'>
    <div className="flex flex-col justify-center mt-[60px]  md:w-[480px] min-h-[650px] mb-14 md:max-h-[900px]">
      <div className="flex justify-center flex-col lg:flex-row gap-6">
        <div className=" max-w-[768px]">
          <div>
            <h2 className="mb-3 text-4xl font-semibold">{house.propertyName}</h2>
          ...
          {/* <div className="mb-8 mt-14 flex w-full max-w-[370px]">
                  <div className="mr-2 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width={16}
                      height={18}
                      viewBox="0 0 16 18"
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-[15px] font-bold text-dark">
                      Phone Number
                    </h4>
  ...
  <p className="mb-2"><strong>Email:</strong> {house.email}</p>
